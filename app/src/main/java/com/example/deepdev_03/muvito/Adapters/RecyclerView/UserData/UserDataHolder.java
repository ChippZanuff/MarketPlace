...
public class UserDataHolder extends RecyclerView.ViewHolder
{
    ...
    public UserDataHolder(View itemView, ImageView image, TextView name, TextView date, RatingBar ratingBar)
    {
        super(itemView);
        this.avatar = image;
        this.name = name;
    ...
    public static UserDataHolder newInstance(View parent) {
        ...
        return new UserDataHolder(parent, image, name, date, ratingBar);
    }
}
